              ...
              @method('PUT')
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input name="kode_barang" type="text" id="kode_barang" value="{{ old('kode_barang', $barang->kode_barang) }}" class="@error('kode_barang') border-red-500 @enderror bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan Kode Barang" required>
                        @error('kode_barang')
                    ...
                    <div>
                        ...
                        <input name="nama_barang" type="text" id="nama_barang" value="{{ old('nama_barang', $barang->nama_barang) }}" class="@error('nama_barang') border-red-500 @enderror bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan Nama Barang" required>
                        @error('nama_barang')
                          <p class="text-red-500 text-xs">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input name="harga" type="number" id="harga" value="{{ old('harga', $barang->harga) }}" class="@error('harga') border-red-500 @enderror bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan Harga" required>
                        @error('harga')
                          <p class="text-red-500 text-xs">{{ $message }}</p>
                        @enderror
                    </div>  
                    <div>
                        ...
                        <select id="kode_stok" class="select2 @error('kode_stok') border-red-500 @enderror" name="kode_stok">
                          <option value="{{ old('kode_stok', $barang->kode_stok) }}" selected>
                            @if (old('kode_stok', $barang->kode_stok))
                              {{ old('kode_stok', $barang->kode_stok) }}
                            @else
                    ...
                    <div>
                        ...
                        @enderror
						  ...
						  <div>
								...
								<input name="jumlah_stok" type="number" id="jumlah_stok" value="{{ old('jumlah_stok', $jml_stok->jumlah_stok ?? 0) }}" 	class="@error('jumlah_stok') border-red-500 @enderror bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 	focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 	dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan Jumlah Stok" required>
								@error('jumlah_stok')
									<p class="text-red-500 text-xs">{{ $message }}</p>
								@enderror
							</div>
