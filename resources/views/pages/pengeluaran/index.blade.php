  ...
  <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
      <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
          ...
          <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
             ...
             <div id="alert-1" class="flex p-4 mb-4 text-blue-800 rounded-lg bg-blue-100 w-1/3" role="alert">
            ...
            {{-- bagian searching bar dan button add product --}}
              @include('partials.pengeluaran.HeadTable')
            {{-- bagian searching bar dan button add product --}}

            {{-- Table Body start --}}
              @include('partials.pengeluaran.TableBody')
            {{-- Table Body end --}}

            {{-- Pagination start --}}
              @include('partials.pengeluaran.Pagination')
            {{-- Pagination end --}}
