              ...
              @csrf
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input name="kode_stok" type="text" id="kode_stok" value="{{ old('kode_stok') }}" class="@error('kode_stok') border-red-500 @enderror bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan Kode Stok" required>
                        @error('kode_stok')
